...
- управление состояниями интерфейса через `useState`
- работа с `useEffect` и `useRef`
- воспроизведение аудио в браузере
- управление громкостью и перемоткой аудио
- модульная структура компонентов
- организация файловой структуры проекта
- UI/UX-проектирование пользовательского интерфейса
